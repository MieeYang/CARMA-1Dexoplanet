...
!! @version Feb-2011
subroutine vaporp_nacl_lee2018(carma, cstate, iz, rc, pvap_liq, pvap_ice)
!     types
  ...
  ! Saturation vapor presure of NaCl from Lee et al. (2018). 

  pvap_liq = 1e6_f * 10._f ** (5.07184_f - TCOEFF_NACL/(t(iz)-82.638_f))
  pvap_ice = pvap_liq
