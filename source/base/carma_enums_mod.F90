...
module carma_enums_mod
  ...
  integer, public, parameter :: I_FIXED_VEL  = 4    !! Fixed Velocity
  ...
  integer, public, parameter :: I_VAPRTN_NACL_LEE2018    = 19  !! NaCl, Lee et al. [2018]
  ...
  integer, public, parameter :: I_GCOMP_NACL             = 16   !! NaCl
